...
namespace QuanLyKhoThucPham.Migrations
{
    ...
    [Migration("20250223030341_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuanLyKhoThucPham.Models.PhieuNhap", b =>
                {
                    b.HasOne("QuanLyKhoThucPham.Models.KhoNhap", "KhoNhap")
                        .WithMany()
                        .HasForeignKey("KhoNhapMaKho")
                    ...
                    b.HasOne("QuanLyKhoThucPham.Models.NhanVien", "NhanVien")
                        .WithMany()
                        .HasForeignKey("NhanVienMaNhanVien")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("KhoNhap");
