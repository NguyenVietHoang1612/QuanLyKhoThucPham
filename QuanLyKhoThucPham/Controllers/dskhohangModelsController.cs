...
namespace QuanLyKhoThucPham.Controllers
{
    public class dskhohangModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,mota")] dskhohangModel dskhohangModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,mota")] dskhohangModel dskhohangModel)
        {
